...
const COMMANDS = {
  ...
  เวลา: () => [
    {
      type: 'text',
      text: `วันเวลาปัจจุบัน: ${new Date().toLocaleString('th-TH')}`,
    },
  ],
  ติดต่อ: () => [
    {
  ...
  แผนที่: () => [
    {
      "type": "location",
      "title": "แผนที่ RSU",
      "address": "52, 347 ถนน พหลโยธิน, Lak Hok, Mueang Pathum Thani District, Pathum Thani 12000",
      "latitude": 13.9649,
      "longitude": 100.5865
    }
  ],
