...
public class FoodList extends javax.swing.JFrame {
    ...
    DefaultTableModel tableModel = new DefaultTableModel(new Object[] {"Food", "Category", "Quantity", "Discounted", "Price", "Cancelled"}, 0) {
        @Override public boolean isCellEditable(int row, int column) { return false; } };
    
    public FoodList() {
        initComponents();
        
        for (OrderDetail order : Database.instance.details) {
            tableModel.addRow(new Object[] { order.menu.name, order.menu.category.name, 
                "%d".formatted(order.amount), "฿ %.2f".formatted(order.discounted), 
                "฿ %.2f".formatted(order.total), order.canceled ? "Yes" : "No"});
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Food", "Category", "Quantity", "Discounted", "Price", "Cancelled"
            }
        ) {
