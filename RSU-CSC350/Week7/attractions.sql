...
(13, 'ดงตาลสามโคก', 'ดงตาลสามโคก เป็นบริเวณของต้นตาลที่ปลูกเรียงกันอย่างโดดเด่นกลางทุ่ง เป็นอะไรที่ลงตัวมาก ๆกับบรรยากาศยามเย็นที่พระอาทิตย์ตกดิน ทำให้สถานที่แห่งนี้เป็นที่ท่องเที่ยวถ่ายรูปสวย ๆ สำหรับนักท่องเที่ยวมี่ชื่นชอบธรรมชาติ นอกจากดงตาลแล้ว ยังมีนาข้าวของชาวบ้านที่ปลูกไว้ เขียวขจีเต็มทุ่งหรือถ้าใครโชคดีก็จะเจอ ฝูงนกบินไปมาสวยงาม จุดชมวิวดงตาลสามโคก สำหรับใครที่ชื่นชอบธรรมชาติ ทุ่งนา และดงตาล แต่ไม่มีเวลาเดินทางไปต่างจังหวัดไกลๆ ดงตาลของชาวบ้าน ที่ยังมีดงตาลต้นสูงลิ่วสวย ๆ ปลูกเรียงกันอย่างโดดเด่นท่วมกลางทุ่ง', 'https://jadtrip.com/data/attachment/forum/202112/13/133825is7q2nvsx1s1q71l.jpg', 14.0344283, 100.5282395),
(14, 'วัดปัญญานันทาราม', ' วัดปัญญานันทาราม ตั้งอยู่ในบริเวณ ตำบลคลองหก อำเภอคลองหลวง จังหวัดปทุมธานี เป็นวัดชื่อดัง และสร้างขึ้นโดย หลวงพ่อปัญญานันทภิกขุ อดีตเจ้าอาวาสวัดชลประทานรังสฤษฏ์ เพื่อให้เป็นมรดกธรรมและสถานที่ปฏิบัติธรรม โดยมี เจดีย์พุทธคยา เป็นไฮไลท์ ซึ่งจำลองแบบมาจากประเทศอินเดียอีกที ตัวของเจดีย์พุทธคยาจำลองนั้น จะเป็นสีเทา มีบ่อน้ำสี่เหลี่ยมขนาดเล็กตั้งอยู่ตรงกลาง ชั้นบนของเจดีย์จะเรียกว่า ชั้นพุทธเมตตา ตรงกลางเจดีย์จะมีรูปหล่อของหลวงพ่อปัญญาประดิษฐานอยู่ด้านหน้าให้ได้กราบไหว้กัน รวมไปถึง วัดปัญญานันทาราม แห', 'https://cms.dmpcdn.com/travel/2020/07/21/b28d0700-cb15-11ea-bbef-893f348e451c_original.jpg', 14.1297109, 100.7256768);
